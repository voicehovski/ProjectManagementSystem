...
public class SkillDao {
    ...
    public static final String DELETE_SKILL_RELATION_QUERY = "DELETE FROM developers_to_skills WHERE skill_id = ?";
    ...
    public int update (Skill entity) {
        try {
            ...
            statement.setString(1, entity.getTrend());
            statement.setString(2, entity.getLevel());
            statement.setLong(3, entity.getId().getId());
    ...
    public int delete (Id id) {
        try {
            PreparedStatement deleteRelationsStatement = connection.prepareStatement(DELETE_SKILL_RELATION_QUERY);
            deleteRelationsStatement .setLong(1, id.getId());
