...
public class SelectDevelopersBySkillLevelQuery extends AbstractQuery<Developer> {
    ...
    public SelectDevelopersBySkillLevelQuery(FilterCondition filterCondition) {
